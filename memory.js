...
function loadRom()
{
	...
	//var rom = returnPong();
	var rom = returnTetris();
	//var rom = returnBreakout();
	//var rom = returnSpace();
	
	for(var i = 0; i < rom.length; i++)
	{
		writeMemory(0x200 + i, rom[i]);
	}
...
function readSprite(address, height)
{
	var newSprite = [];
