...
{
	//Set VX += VY
	chipRegisters[0xF] = (chipRegisters[x] + chipRegisters[y] > 0xFF) ? 1 : 0;
	chipRegisters[x] += chipRegisters[y];
}
...
{
	//Set VX -= VY
	chipRegisters[0xF] = (chipRegisters[x] > chipRegisters[y]) ? 1 : 0;
	chipRegisters[x] -= chipRegisters[y];
}
...
{
	//Set VX >>= 1
	chipRegisters[0xF] =((chipRegisters[x] & 0x1) > 0) ? 1 : 0;
	chipRegisters[x] >>= 1;
}
